...
** ===================================================================
*/
__attribute__((naked)) void w_Wait10Cycles(void)
{
...
** ===================================================================
*/
__attribute__((naked)) void w_Wait100Cycles(void)
{
...
void w_Waitms(uint16_t ms)
{
  ...
  msCycles = w_NofCyclesMs(1, CPU_CORE_CLK_HZ);
  while(ms>0) {
    w_WaitLongCycles(msCycles);
    ms--;
  }
}
/*
